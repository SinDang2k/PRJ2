...
<body class="fp-page">
    <div class="fp-box">
        <div class="logo">
            <a href="javascript:void(0);">Teacher<b> Quên mật khẩu</b></a>
        </div>
        <div class="card">
            <div class="body">
                <form id="forgot_password" action="{{ route('teacher.send_email_forgot_password_teacher') }}" method="POST">
                    @csrf
                    <div class="msg">
        ...
        $(document).ready(function () {
            $("#forgot_password").keyup(function (e) {
                ...
                else if(regex_email.test($("#email").val())==false)
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('teacher.check_exist_email_teacher')}}",
                        data: {
                            email:$("#email").val(),
                            _token:"{{csrf_token()}}",
                        },
