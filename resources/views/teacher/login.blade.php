...
<body id="particle">
    <div class="container">
        <div id="form">
            ...
            <form @submit="checkForm" id="formLogin" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-left">
                        ...
                        <input type="text" id="email" placeholder="Enter E-Mail" autocomplete="off" v-model="email"
                            name="email">
                    </div>
                </div>
                <div class="form-group">
            ...
            <p>Forgot password? <a href="{{ route('teacher.forgot_password') }}">Click Here</a></p>
        </div>
        <div id="sidenav" class="sidenav">
            <a href="{{ route('admin.getLogin') }}" id="bar2">Admin</a>
        </div>
    </div>
