                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div align="right" style="margin-bottom: 15px">
                            <a href="{{ route('department.view_insert') }}" class="btn btn-success btn-sm"
                            style="width: 85px; outline: none;"><i class="fas fa-plus"
                            style="margin-right: 2px"></i>Thêm mới</a>
                        </div>
                        <form action="{{ route('department.del') }}" method="post">
                            @csrf
                            <table class="table table-striped table-bordered" id="department_tables">
                                <thead>
                                    <tr>
...
<script>
    $(document).ready(function() {
        $('#department_tables').DataTable({
            ...
            // 'csv', 'excel'
            // ],
            ajax: '{!! route('department.view_all') !!}',
            columns: [
            { data: 'id', 
            'orderable':false,
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    setTimeout(function(){
                        ...
                        $('#department_tables').DataTable().ajax.reload();
