                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div align="right" style="margin-bottom: 15px">
                            <a href="{{ route('classes.view_insert') }}" class="btn btn-success btn-sm"
                                style="width: 85px; outline: none;"><i class="fas fa-plus"
                                    style="margin-right: 2px"></i>Thêm mới</a>
                        </div>
                        <form action="{{ route('classes.del') }}" method="post">
                            @csrf
                            <table class="table table-striped table-bordered" id="classes_tables">
                                <thead>
                                    <tr>
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    setTimeout(function(){
                        ...
                        $('#classes_tables').DataTable().ajax.reload();
