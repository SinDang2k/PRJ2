...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 organize, share and use all your visual assets in one place - all on your desktop." height="32" src="http://localhost/project2/public/img/logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
@isset($that_bai)
<img align="center" alt="Forgot your password?" class="mcnImage" src="{{ asset('public/upload/images.png') }}" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
...
@endisset
 ...
 padding: 0'><span style="text-transform:uppercase">
@isset($that_bai)
    Thất
@else
ĐỔI
...
@isset($that_bai)
    @isset($token_loi)
        Đường link này đã xóa hoặc hết hạn
    @else
        Bạn đã dùng chức năng đổi mật khẩu này quá nhiều lần trong ngày.
    @endisset
@else
Chúng tôi đã gửi tin nhắn bạn có thể vào đó để đổi mật khẩu
@endisset
                                <br></br>
                              </td>
                            </tr>
...
@isset($that_bai)
    @isset($token_loi)
        @if ($position==1)
            <a class="mcnButton " href="{{route('admin.getLogin')}}" style="mso-line-height-rule: exactly;
            ...
            invitation">Quay về trang đăng nhập</a>
        @else
            <a class="mcnButton " href="{{route('teacher.getLogin')}}" style="mso-line-height-rule: exactly;
            -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: #f57153;
            font-weight: normal; text-decoration: none; font-weight: normal;letter-spacing:
            1px;line-height: 100%;text-align: center;text-decoration: none;color:
            #FFFFFF; text-transform:uppercase;" title="Review Lingo kit
        ...
        @endif
    @else
    <a class="mcnButton " href="{{ url()->previous() }}" style="mso-line-height-rule: exactly;
        -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: #f57153;
        font-weight: normal; text-decoration: none; font-weight: normal;letter-spacing:
        1px;line-height: 100%;text-align: center;text-decoration: none;color:
        #FFFFFF; text-transform:uppercase;" title="Review Lingo kit
        invitation">Quay lại trang trước</a>
    @endisset
@else
<a class="mcnButton " href="https://mail.google.com/mail/u/0/#inbox" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: #f57153;
 font-weight: normal; text-decoration: none; font-weight: normal;letter-spacing:
 1px;line-height: 100%;text-align: center;text-decoration: none;color:
 #FFFFFF; text-transform:uppercase;" target="_blank" title="Review Lingo kit
 invitation">Vào email</a>
@endisset
                                      </td>
                                    </tr>
                                  </tbody>
